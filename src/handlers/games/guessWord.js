  ...
  client.on(Discord.Events.MessageCreate, async (message) => {
    ...
    if (data) {
      if (message.content.toLowerCase() == data.Word.toLowerCase()) {
        ...
        client.embed({
          title: `<:blue_chataILD:1371180174833483876>・Guess the word`,
          desc: `The word is guessed and has a value of $${amount}`,
          fields: [
            {
              name: `<:CS_Profile:1371336333687259231>┇Guessed by`,
              value: `${message.author} (${message.author.tag})`,
              inline: true
            },
            {
              name: `<:blue_chataILD:1371180174833483876>┇Correct word`,
              value: `${data.Word}`,
              inline: true
            }
          ]
