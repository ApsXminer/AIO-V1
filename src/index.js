...
app.get("/", (req, res) => {
    ...
    res.send(`<iframe style="margin: 0; padding: 0;" width="100%" height="100%" src="https://discord.gg/3xzPkYHd9U" frameborder="0" allowfullscreen></iframe>`);
    res.end()
});
...
process.on('unhandledRejection', error => {
    ...
    const embed = new Discord.EmbedBuilder()
        .setTitle(`<:blue_warn:1371179553057411248>・Unhandled promise rejection`)
        .addFields([
            {
                name: "Error",
...
process.on('warning', warn => {
    ...
    const embed = new Discord.EmbedBuilder()
        .setTitle(`<:blue_warn:1371179553057411248>・New warning found`)
        .addFields([
            {
                name: `Warn`,
                value: `\`\`\`${warn}\`\`\``,
