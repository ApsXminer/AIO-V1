        ...
        client.simpleEmbed({
            ...
            client.embed({
                ...
                fields: [
                    ...
                    {
                        name: `<:blue_question_mark:1371179156573782128> ┆What can I do here?`,
                        value: `- Meet new people! \n- Play many fun games! \n- Discover the seasons! \n- Participate in events! \nAnd…. Last but not least, choose your own roles at <#847867992044994561>!`,
                    },
                    {
                        name: `<:blue_ticket:1371337519588708432> ┆How do I get help when needed?`,
                    ...
                    {
                        name: `<:settings_blue:1371330094668189766>┆I want to help Bot Hangout to improve!`,
        ...
        client.simpleEmbed({
            ...
            client.embed({
                ...
                fields: [
                    ...
                    {
                        name: `<:BlueGiveaway:1371358779257393175>  ┆Access to the beta program`,
    ...
    if (message == "boosterperks") {
        client.simpleEmbed({
            ...
            client.embed({
                ...
                fields: [
                    {
                        name: `<:BlueColorRole:1371336699694678037>┆Use external stickers`,
                        value: `Use stickers from other servers in our server`,
                    },
                    {
                        name: `<:Voice:1371337642511175741>┆Send TTS messages`,
                    ...
                    {
                        name: `<:stats:1371336857794904167>┆Get access to a special promotional channel`,
                    ...
                    {
                        name: `<:blue__comp:1371330577537564754>┆Access to new bèta updates in Bot`,
    ...
    if (message == "rewards") {
        client.embed({
            ...
            fields: [
                ...
                {
                    name: `<:BlueGiveaway:1371358779257393175>  ┆Special`,
                    value: `- 1 server vote | <@&833959913742794772>\n- 1 boost | <@&744208324022501447>\n- 1 donate | <@&849554599371210793>`,
                },
                {
                    name: `<:gd_money_blue:1371360378860212314>┆Economy`,
        ...
        client.simpleEmbed({
            ...
            client.embed({
                ...
                fields: [
                    ...
                    {
                        name: `<:Music_blue:1371336544626933790>┆What is Bot 2?`,
                    ...
                    {
                        name: `<:Invite_Blue:1371335831750709318> ┆How do I invite the bots?`,
