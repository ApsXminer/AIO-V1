...
module.exports = async (client, interaction, args) => {
    ...
    if (boolean == true) {
        ...
        let embedLogs = new Discord.EmbedBuilder()
            ...
            .addFields(
                { name: "<:CS_Profile:1371336333687259231>┆Added By", value: `${interaction.user} (${interaction.user.tag})`, inline: true },
        ...
        let embedLogs = new Discord.EmbedBuilder()
            ...
            .addFields(
                { name: "<:CS_Profile:1371336333687259231>┆Removed By", value: `${interaction.user} (${interaction.user.tag})`, inline: true },
                { name: `📛┆Badge`, value: `${badgeFlags[badge.toUpperCase()]} (${badge.toUpperCase()})`, inline: true },
            )
            .setColor(client.config.colors.normal)
            .setFooter({ text: client.config.discord.footer })
