...
module.exports = async (client, message) => {
  ...
  if (message.channel.type === Discord.ChannelType.DM) {
    let embedLogs = new Discord.EmbedBuilder()
      .setTitle(`<:blue_chataILD:1371180174833483876>・New DM message!`)
      .setDescription(`Bot has received a new DM message!`)
      .addFields(
        { name: "<:CS_Profile:1371336333687259231>┆Send By", value: `${message.author} (${message.author.tag})`, inline: true },
        { name: `<:blue_chataILD:1371180174833483876>┆Message`, value: `${message.content || "None"}`, inline: true },
      )
      ...
      .embed(
        {
          ...
          fields: [
            {
              name: "<:Invite_Blue:1371335831750709318> ┆Invite me",
              value: `Invite Bot in your own server! [Click here](${client.config.discord.botInvite})`,
            },
            {
              name: "<:blue_question_mark:1371179156573782128> ┇I don't see any slash commands",
              value:
            ...
            {
              name: "<:blue_question_mark:1371179156573782128> ┆Need support?",
