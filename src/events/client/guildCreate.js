...
module.exports = async (client, guild) => {
  ...
  try {
    ...
    client.embed({
      ...
      fields: [{
        name: "<:blue_question_mark:1371179156573782128> ┆How to setup?",
      ...
      {
        name: "<:blue__comp:1371330577537564754>┆What are the commands?",
        value: 'See that list of commands by doing \`/help\`',
        inline: false,
      },
      {
        name: "<:Invite_Blue:1371335831750709318> ┆Invite the bot!",
