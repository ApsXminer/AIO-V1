...
module.exports = async (client) => {
    ...
    setInterval(async function () {
        ...
        if (process.env.DISCORD_STATUS) {
            ...
            statuttext = [
                `・<:blue_question_mark:1371179156573782128> ┆/help`,
                `・<:blue__comp:1371330577537564754>┆${client.guilds.cache.size} servers`,
                `・<:Invite_Blue:1371335831750709318> ┆https://discord.gg/3xzPkYHd9U`,
                `・🎉┆400+ commands`,
